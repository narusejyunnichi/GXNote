...
SWIFT_MODULE_NAMESPACE_PUSH("GXNote")

SWIFT_CLASS("_TtC6GXNote11GXNoteStyle")
@interface GXNoteStyle : NSObject
...
SWIFT_CLASS("_TtC6GXNote10GXNoteView")
@interface GXNoteView : UIView <UITextViewDelegate>
